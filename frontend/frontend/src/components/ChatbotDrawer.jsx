    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-40">
        <button
          ...
          className="relative p-4 rounded-2xl bg-gradient-to-tr from-red-600 via-rose-600 to-amber-500 hover:from-red-500 hover:to-rose-500 text-white shadow-2xl shadow-red-600/50 flex items-center justify-center transition-all hover:scale-105 active:scale-95 group"
          title="Open AI Tariff Advisor Chatbot"
        >
          ...
          >
            ...
            >
              ...
              <button
                ...
                className="p-2.5 rounded-xl bg-gradient-to-r from-red-600 via-rose-600 to-red-500 hover:from-red-500 hover:to-rose-500 text-white shadow-md disabled:opacity-40 transition-all active:scale-95 shrink-0"
              >
